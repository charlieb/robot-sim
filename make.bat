REM c:\Localdata\gtk2.24-32\bin>pkg-config.exe --cflags --libs gtk-win32-2.0
...
set LIBS=-Lc:/Localdata/gtk2.24-32/lib -lgtk-win32-2.0 -lgdk-win32-2.0 -latk-1.0 -lgio-2.0 -lpangowin32-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lpango-1.0 -lcairo -lgobject-2.0 -lgmodule-2.0 -lgthread-2.0 -lglib-2.0 -lintl
